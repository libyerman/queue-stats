...
echo " > ".$lang["$language"]['yesterday']."  </a> | ";
//
...
<INPUT TYPE=submit VALUE='<?php echo $lang["$language"]['display_report']?>' onClick='return envia();'>
		...
		<br />
<p>
<b><?php echo $lang["$language"]['sync']?>:</b>
</p>
<table><tr><td>		
<form method="post" action="sync.php">
<input type=hidden name="queue_sync">
<input type=submit value="<?php echo $lang["$language"]['queues']?>">
</form>
</td><td>
<form method="post" action="sync.php">
<input type=hidden name="agent_sync">
<input type=submit value="<?php echo $lang["$language"]['agents']?>">
</form>
</td></tr></table>
	</div>
</div>
