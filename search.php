...
<div id="main">
    <div id="contents">
        ...
        <TR>
   		...
   		<br />
		<h4><?php echo $lang["$language"]['cod_event_queue']?></h4>
		<br />
	<table>
	<thead>
	<tr>
		<th class="col0"><?php echo $lang["$language"]['event']?></th><th class="col1">data1</th><th class="col2">data2</th><th class="col3">data3</th>
	</tr>
	</thead>
	<tr>
		<td class="col0">ENTERQUEUE</td><td class="col1"></td><td class="col2">callerid</td><td class="col3"><?php echo $lang["$language"]['enterposition']?></td>
	</tr>
	<tr>
		<td class="col0">CONNECT</td><td class="col1"><?php echo $lang["$language"]['holdtime']?></td><td class="col2">uniqueid</td><td class="col3"> </td>
	</tr>
	<tr>
		<td class="col0">COMPLETEAGENT, COMPLETECALLER</td><td class="col1"><?php echo $lang["$language"]['holdtime_answer']?></td><td class="col2"><?php echo $lang["$language"]['calltime']?></td><td class="col3"><?php echo $lang["$language"]['connposition']?></td>
	</tr>
	<tr>
		<td class="col0">RINGNOANSWER</td><td class="col1"><?php echo $lang["$language"]['calltime_agent']?> (Agent Timeout)</td><td class="col2"> </td><td class="col3"> </td>
	</tr>
    <tr>
		<td class="col0">ABANDON</td><td class="col1"><?php echo $lang["$language"]['hangupposition']?></td><td class="col2"><?php echo $lang["$language"]['enterposition']?></td><td class="col3"><?php echo $lang["$language"]['holdtime']?></td>
	</tr>
	<tr>
		<td class="col0">EXITWITHTIMEOUT</td><td class="col1"><?php echo $lang["$language"]['hangupposition']?></td><td class="col2"><?php echo $lang["$language"]['enterposition']?></td><td class="col3"><?php echo $lang["$language"]['holdtime_queue']?></td>
	</tr>
</table>
		<br/>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="frm1" name="frm1" method="post">
	...
	&nbsp;&nbsp;&nbsp;<input type="checkbox" name="alltime" value="alltime">&nbsp;<?php echo $lang["$language"]['search_all_time'];?><br/><br/>
